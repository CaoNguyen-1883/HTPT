...
// Demo scenarios
export async function runMobileAgentDemo() {
  const response = await api.post('/demo/mobile-agent')
  return response.data
}

export async function runLoadBalancingDemo() {
  const response = await api.post('/demo/load-balancing')
  return response.data
}

export async function runFaultToleranceDemo() {
  const response = await api.post('/demo/fault-tolerance')
  return response.data
}
